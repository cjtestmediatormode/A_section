...
Pod::Spec.new do |s|
  ...
  s.description  = “模块A业务代码,用于主工程的引用”
  ...
  s.author             = { "zhusf" => "496795352@qq.com" }
  # Or just: s.author    = "zhusf"
  # s.authors            = { "zhusf" => "496795352@qq.com" }
  # s.social_media_url   = "http://twitter.com/zhusf"
  ...
  # s.exclude_files = "A_sectionKit/Exclude"
